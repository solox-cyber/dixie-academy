<x-guest-layout title="Join As A Class">

    <style>
        section.contact-us #contact input, select {
  width: 100%;
  height: 45px;
  border-radius: 20px;
                        ...
                        <div class="col-lg-12">
                            <form id="contact" action="#" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <fieldset>
                                            <button type="submit" id="form-submit" class="button">ENROLL TODAY</button>
                                        </fieldset>
                                    </div>
                                </div>
                            </form>
