<x-guest-layout title="Resource Details Page">
    <style>
        section.heading-course-page {
            background-image: url({{$resource->getThumbnailImage()}});
                        ...
                        <div class="col-lg-12">
                            <div class="meeting-single-item">
                                <div class="thumb">
                                    <div class="price">
                                        <span>
                                            @if ($resource->price<=0) Free @else ${{$resource->price}}
                                                @endif
                                        </span>
                                    </div>
                                </div>
                                <div class="down-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="main-button-red">
                                            <a href="{{asset('storage/'.$resource->fileUploaded)}}" download>Download Ebook</a>
                                        </div>
