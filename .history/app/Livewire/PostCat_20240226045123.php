...
class PostCat extends Component
{
    ...
    public function fetchPostsByCategory($categoryTitle)
{
    ...
    return view('livewire.post-cat', ['posts' => $posts]);
}

public function navigateToSearch($categoryTitle)
{
    return redirect()->route('blog.search', ['category' => $categoryTitle]);
}
