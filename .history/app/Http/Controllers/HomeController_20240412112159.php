...
class HomeController extends Controller
{
    ...
    public function teachteam()
    {
        return view('teach_team');
    }
    ...
    public function sendEmail(Request $request)
    {
        ...
        $messagebox = $request->input('message');

        Mail::to('support@dixieacademy.com')->send(new ContactFormMail($name, $email, $subject, $messagebox));
