                            ...
                            <div class="meeting-single-item">
                                ...
                                <div class="down-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="btn-cat" style="color:{{$category->text_color}}!important; background:{{ $category->bg_color}}!important"><a style="border-radius:22px!important">{{$category->title}}</a>
                                            </div>
                                        </div>
