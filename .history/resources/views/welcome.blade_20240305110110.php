        ...
        <div class="container">
          <div class="row">
            ...
            <div class="main-button-red">
                <div class="scroll-to-section"><a wire:navigate href="{{route('courses')}}">Join Us Now!</a></div>
            </div>
        </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="item">
                ...
                <div class="main-button-red">
                  <div class="scroll-to-section"><a wire:navigate href="{{route('about')}}">View more</a></div>
              </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="item">
                ...
                <div class="main-button-yellow">
                  <div class="scroll-to-section"><a href="{{route('about')}}">View more</a></div>
              </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-4">
        <div class="categories">
          ...
          <ul>
            ...
            <li><a wire:navigate href="{{route('blog', ['category' => $category->slug])}}">{{$category->title}}</a></li>
            <br>
            @endforeach
          ...
          <div class="main-button-red">
            <a href="{{route('blog')}}">All Blog Posts</a>
          </div>
        </div>
      </div>
      <div class="col-lg-8">
          ...
          <div class="col-lg-6">
            <div class="meeting-item">
              <div class="thumb">
                ...
                <a wire:navigate href="{{route('blog.show', $post->slug)}}"><img src="{{ $post->getThumbnailImage() }}" alt=""></a>
              </div>
              <div class="down-content">
                <div class="date">
