                        ...
                        <div class="col-lg-12">
                            <div class="meeting-single-item">
                                ...
                                <div class="down-content">
                                    <h4>{{$post->title}}</h4>
                                    <p>Written by <strong>{{$post->author->name}}</strong> || {{$post->getReadingTime()}} min read </p>
                                            ...
                                            <div class="col-lg-12">
                                              <form id="contact" action="#" method="post">
                                                <div class="row">
                                                  ...
                                                  <div class="col-lg-12">
                                                    <fieldset>
                                                      <button type="submit" class="main-button-red" class="button">SEND MESSAGE NOW</button>
                                                    </fieldset>
                                                  </div>
                                                </div>
                                              </form>
