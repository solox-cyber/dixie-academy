<div>
    <div x-data="{
        ...
        <div class="row mb-4">
            <div class="col-lg-6" style="color:#f5a425; display: flex; align-items: center;">
                @if ($this->activeCategory || $search)
                    <button class="bg-success" style="color:#fff; background: #ff2a2a!important; padding:8px 10px; margin-right: 10px;" wire:click="clearFilters()">X</button>
                @endif
    ...
    border-radius:12px;
                ...
                @if ($this->activeCategory)
                    <x-badge wire:navigate href="{{ route('blog', ['category' => $this->activeCategory->slug]) }}"
                        class="custom-badge"  :textColor="$this->activeCategory->text_color" :bgColor="$this->activeCategory->bg_color">
          ...
          <div class="col-lg-" style="margin-top:30px">
            ...
            <div class="row">
                ...
                <div class="col-lg-6" style="margin-top:30px">
                    ...
                    <x-button x-on:click="$dispatch('search', { search: query })" class="float-end">Search</x-button>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            @foreach ($post->categories as $category)
                ...
                <div class="meeting-item">
                    <div class="thumb">
                        @foreach ($post->categories as $category)
                        <div class="price" wire:navigate href="{{route('blog', ['category' => $category->title])}}" style="font-size: 8px; margin-top:
