            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div id="comments" style="margin-top:40px">
                        ...
                        <div class="comment" style="margin-bottom:2">
                            <div class="comment-info">
                                <span class="author"><img src="{{$comment->user->profile_photo_path}}" alt="{{$comment->user->name}}" /> <strong>{{$comment->user->name}}</strong></span>
