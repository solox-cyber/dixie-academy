              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav" style="text-align:center!important">
                        ...
                        <x-nav-link href="{{ route('whoami') }}" :active="request()->routeIs('whoami')">
                            {{ __('Who Am I') }}
                        </x-nav-link>
                        ...
                        <x-nav-link href="{{ route('blog') }}" :active="request()->routeIs('blog')">
                         ...
                         <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                ...
                                <x-nav-link href="{{ route('profitable') }}" :active="request()->routeIs('profitable')">
                                    {{ __('Want to be profitable') }}
                                </x-nav-link>

                              </ul>
                          </li>
                          <x-nav-link href="{{ route('home') }}#contact" :active="request()->routeIs('dashboard')">
                            {{ __('Contact Us') }}
                        </x-nav-link>
                        ...
                        <x-nav-link href="{{ route('register') }}" :active="request()->routeIs('register')">
                          ...
                          @endguest
                          <x-nav-link navigate='' href="{{ route('filament.1.auth.login') }}" :active="request()->routeIs('filament.1.auth.login')">
                            {{ __('Admin') }}
                        </x-nav-link>
                          @auth
