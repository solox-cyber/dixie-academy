                            ...
                            <div class="meeting-single-item">
                                ...
                                <div class="down-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 main-button-green">
                                            <div style="background:{{$category->text_color}}!important; color:{{$category->text_color}}!important">
                                                <a style="background:{{$category->text_color}}!important; color:{{$category->text_color}}!important" wire:navigate href="{{route('blog', ['category' => $category->slug])}}">{{$category->title}}</a>
                                            </div>
                                        </div>
