                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="item">
                                ...
                                <div class="main-button-red">
                                    <div class="scroll-to-section"><a wire:navigate href="{{ route('about', ['id' => 3]) }}">View
                                            more</a></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="owl-courses-item owl-carousel">
                        ...
                        <div class="item">
                            <img src="{{ $resource->getThumbnailImage() }}" alt="{{$resource->title}}" style="height:220px;width:500px;!important">
                            <div class="down-content">
                                ...
                                <div class="info">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="main-button-red">
                                                <a wire:navigate href="{{route('resource.show', $resource->id)}}">Purchase</a>
                                            </div>
                                        </div>
                                        <div class="col-4">
